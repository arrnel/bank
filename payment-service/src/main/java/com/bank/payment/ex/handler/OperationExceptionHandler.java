package com.bank.payment.ex.handler;

import com.bank.payment.controller.kafka.OperationResultProducer;
import com.bank.payment.data.enums.OperationStatus;
import com.bank.payment.ex.CurrencyNotFoundException;
import com.bank.payment.ex.IllegalOperationException;
import com.bank.payment.ex.OperationProcessingException;
import com.bank.payment.model.dto.ApiErrorDTO;
